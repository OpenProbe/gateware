...
class Zedboard(Elaboratable):
    def elaborate(self, platform):
        ...
        m.d.comb += [
            platform.request("led", 0).o.eq(platform.request("switch", 0)),
            platform.request("led", 1).o.eq(platform.request("switch", 1)),
            platform.request("led", 2).o.eq(platform.request("switch", 2)),
            platform.request("led", 3).o.eq(platform.request("switch", 3)),
            platform.request("led", 4).o.eq(platform.request("switch", 4)),
            platform.request("led", 5).o.eq(platform.request("switch", 5)),
            platform.request("led", 6).o.eq(platform.request("switch", 6)),
            platform.request("led", 7).o.eq(platform.request("switch", 7)),
        ]
...
if __name__ == '__main__':
    ...
    ZedboardPlatform().build(elaboratable=Zedboard())
